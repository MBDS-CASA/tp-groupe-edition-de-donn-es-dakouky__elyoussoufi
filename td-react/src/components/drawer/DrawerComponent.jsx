...
const menuItems = [
  ...
  { id: 'notes', text: 'Notes', icon: <NoteIcon />, component: NotesComponent },
  { id: 'students', text: 'Students', icon: <PersonIcon />, component: StudentsComponent },
  { id: 'subjects', text: 'Subjects', icon: <BookIcon />, component: SubjectsComponent },
